...
public class SaladAndDessertMealsIntroduction extends AppCompatActivity implements Adress {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SaladAndDessertMealsIntroduction.BackgroundTask2().execute();
    }
    ...
    public class BackgroundTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                document = (Jsoup.connect(saladDessertIntroductionWebSite).get());
            } catch (IOException e) {
                e.printStackTrace();
            }

            Elements main = document.select(saladDessertIntroductionCategoriesHtml);
            Elements details = document.select(saladDessertIntroductionDetailsHtml);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListviewAdapter listviewAdapter = new ListviewAdapter(SaladAndDessertMealsIntroduction.this, mealsUpdate.getMealsLists(), mealsUpdate.getDetailsLists());
