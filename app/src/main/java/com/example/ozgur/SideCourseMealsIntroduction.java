...
public class SideCourseMealsIntroduction extends AppCompatActivity implements Adress {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new SideCourseMealsIntroduction.BackgroundTask2().execute();
    }
    ...
    public class BackgroundTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                document = (Jsoup.connect(sideCourseMealsIntroductionWebSite).get());
            } catch (IOException e) {
                e.printStackTrace();
            }

            Elements main = document.select(sideCourseMealsIntroductionCategoriesHtml);
            Elements details = document.select(sideCourseMealsIntroductionDetailsHtml);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListviewAdapter listviewAdapter = new ListviewAdapter(SideCourseMealsIntroduction.this, mealsUpdate.getMealsLists(), mealsUpdate.getDetailsLists());
