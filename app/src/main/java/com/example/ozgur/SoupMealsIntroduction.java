...
public class SoupMealsIntroduction extends AppCompatActivity implements Adress {

    MealsUpdate mealsUpdate = new MealsUpdate();
    ...
    public class BackgroundTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                document = (Jsoup.connect(soupMealsIntroductionWebSite).get());
            } catch (IOException e) {
                e.printStackTrace();
            }

            Elements main = document.select(soupMealsIntroductionCategoriesHtml);
            Elements details = document.select(soupMealsIntroductionDetailsHtml);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListviewAdapter listviewAdapter = new ListviewAdapter(SoupMealsIntroduction.this, mealsUpdate.getMealsLists(), mealsUpdate.getDetailsLists());
